...
@app.route('/')
def hello():
    results = pd.DataFrame(columns=["name", "accuracy", "has_contribs", "has_ablation", "has_ss_ablation", "has_heatmap", "has_add_ablation_figure", "has_remove_ablation_figure"])
    ...
    for name in names:
        ...
        try:
            ...
            if contribs[0] == "[":
                results.loc[name]["has_contribs"] = True
        except:
            pass
        try:
            ...
            if "Entry not found" not in ablation:
                results.loc[name]["has_ablation"] = True
        except:
            pass
        try:
            ...
            if "Entry not found" not in ss_ablation:
                results.loc[name]["has_ss_ablation"] = True
        except:
            pass
        try:
            ...
            if "Entry not found" not in heatmap:
                results.loc[name]["has_heatmap"] = True
        except:
            pass
        try:
            ...
            if "Entry not found" not in add_ablation_figure:
                results.loc[name]["has_add_ablation_figure"] = True
        except:
            pass
        try:
            ...
            if "Entry not found" not in remove_ablation_figure:
                results.loc[name]["has_remove_ablation_figure"] = True
        except:
            pass
